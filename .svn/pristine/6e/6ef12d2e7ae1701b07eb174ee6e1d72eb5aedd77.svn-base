...
namespace TIGE.Controllers
{
    ...
    public class ProfileController : BaseController
    {
        ...
        {
            await _userService.ConfirmUpdateProfileAsync(token);
        ...
        public async Task<IActionResult> Update([FromForm] UpdateProfileModel model)
        {
            ...
            try
            {
                ...
                return RedirectToAction("Verify", "Verify", new { type = Enums.VerifyType.UpdateProfile.ToString(), data = LoggedInUser.Current.Id });
            }
            catch (Exception e)
            {
