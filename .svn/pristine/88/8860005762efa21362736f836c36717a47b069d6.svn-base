var mApp = function() {
    ...
    return {
        ...
        destroyScroller: function(e) {
            mUtil.hasClass(e, "mCustomScrollbar") && (e.mCustomScrollbar("destroy"), e.removeClass("mCS_destroyed"))
        },
        alert: function(e) {
            e = $.extend(!0, {
                container: "",
        ...
        if (o) {
            var a = {
                ...
                r = {
                    ...
                    init: function(e) {
                        l.element = o, l.events = [], l.options = mUtil.deepExtend({}, a, e), l.steps = mUtil.findAll(o, ".m-wizard__step"), l.progress = mUtil.find(o, ".m-wizard__progress .progress-bar"), l.bTIGEubmit = mUtil.find(o, '[data-wizard-action="submit"]'), l.btnNext = mUtil.find(o, '[data-wizard-action="next"]'), l.btnPrev = mUtil.find(o, '[data-wizard-action="prev"]'), l.btnLast = mUtil.find(o, '[data-wizard-action="last"]'), l.btnFirst = mUtil.find(o, '[data-wizard-action="first"]'), l.events = [], l.currentStep = 1, l.totalSteps = l.steps.length, 1 < l.options.startStep && r.goTo(l.options.startStep), r.updateUI()
                    },
                    build: function() {
...
var mLayout = function() {
    ...
    return {
        ...
        initAside: function() {
            var e, t, a;
            e = mUtil.get("m_aside_left"), t = mUtil.hasClass(e, "m-aside-left--offcanvas-default") ? "m-aside-left--offcanvas-default" : "m-aside-left", o = new mOffcanvas("m_aside_left", {
                baseClass: t,
                overlay: !0,
                ...
                var e = $(this).find("> .m-menu__submenu > .m-menu__wrapper");
                if (mUtil.isInResponsiveRange("tablet-and-mobile")) mApp.destroyScroller(e);
                else {
                    var t = mUtil.getViewPort().height;
                    mApp.initScroller(e, {
                        height: t
                    }, !0)
                }
            }), a = "1" === $("#m_ver_menu").data("m-menu-dropdown") ? "dropdown" : "accordion", n = new mMenu("m_ver_menu", {
                submenu: {
                    desktop: {
                        default: a,
                        state: {
